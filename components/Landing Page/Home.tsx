    ...
    return (
      ...
      <div className="relative overflow-x-hidden bg-[radial-gradient(125%_125%_at_50%_10%,#000_40%,#63e_100%)]">
        ...
        <div className="w-full flex flex-wrap justify-center gap-5 mt-10 px-4 sm:px-6 md:px-0">
          {/* Feature Box 1 */}
          <div className="w-full sm:w-[48%] md:w-[250px] h-[240px] border-[1px] border-gray-400 rounded-[9px] p-4 flex flex-col items-start shadow-md bg-[rgba(99,102,241,0.1)]">
            ...
            <h3 className="text-xl md:text-lg font-semibold mb-2 mt-4 ">Meeting Room</h3>
          ...
          <div className="w-full sm:w-[48%] md:w-[250px] h-[240px] border-[1px] border-gray-400 rounded-[9px] p-4 flex flex-col items-start shadow-md bg-[rgba(99,102,241,0.1)]">
            ...
            <h3 className="text-xl md:text-lg font-semibold mb-2 mt-4 ">Publish your doc online</h3>
          ...
          <div className="w-full sm:w-[48%] md:w-[250px] h-[240px] border-[1px] border-gray-400 rounded-[9px] p-4 flex flex-col items-start shadow-md bg-[rgba(99,102,241,0.1)]">
            ...
            <h3 className="text-xl md:text-lg font-semibold mb-2 mt-4 ">Collaborative Editing</h3>
          ...
          <div className="w-full sm:w-[48%] md:w-[250px] h-[240px] border-[1px] border-gray-400 rounded-[9px] p-4 flex flex-col items-start shadow-md bg-[rgba(99,102,241,0.1)]">
            ...
            <h3 className="text-xl md:text-lg font-semibold mb-2 mt-4 ">AI Auto-completion</h3>
